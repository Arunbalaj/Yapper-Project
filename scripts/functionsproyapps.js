  ...
  $("#submityapp").click(function(event){
    var name = document.getElementById("name").value; 
     var d1 = document.getElementById("startdate").value; 
      ...
      var stt = document.getElementById("region").value; 
      var raa = document.getElementById("radius").value;
    ...
    if(raa == null || raa == ""&& long == null || long == "" && lat == null || lat==""){
    ...
    function checkdate()
    {
      ...
      Fromdate1.setDate(FromDate.getDate());
      ToDate1.setDate(ToDate.getDate());
         ...
         var CurDate = new Date(valCurDate);
          ...
          {
              alert("Start date should not be lesser than today's date");
              return false; 
          }
...
var data = new FormData();
   ...
   List();
   $('#imaaa,#name,#initialmessage,#startdate,#enddate,#cat,#craeted,#cit,#regnss,#latitude,#longitude,#radius,#region,#city,#cate,#addre').val(''); 
 ...
 //  alert('successfully Inserted');
    ...
    function(jqXHR, textStatus, errorThrown){
     ...
     alert("Please select a unique Yapp Name");
      }
    }
        ...
        console.log( data);
  		...
  		if(dashboard)
              ...
              $("#tblList2").append(
            		  "<tr>"+
            		  deleteCol+
                           "  <td>"+"&nbsp"+valCurDate+"</td>" + 
                             " <td>"+cli.name+"</td>" + 
                           "  <td>"+cli.region+"</td>" + 
                           "  <td>"+"&nbsp"+cli.genre+"</td>" + 
                           "  <td class='aff'>"+"&nbsp"+loct+"</td>" + 
                             " <td>"+"&nbsp"+cli.distanceLimit+"</td>" + 
                           "  <td>"+"&nbsp"+cli.type+"</td>" + 
                           "  <td>"+"&nbsp"+valCurexp+"</td>" + 
                           " <td>"+"&nbsp"+des+"</td>" + 
                           "  <td>"+"&nbsp"+cli.creatorName+"</td>" + 
                           "  <td>"+"&nbsp"+cli.id+"</td>" + 
                             "  <td>"+"&nbsp"+cli.status+"</td>" +
          ...
          $(".btnDelete").bind("click", function(){
            console.log(delArray.length);
             if(delArray.length == 0||delArray==null){//||delArray.allValuesSame()==true){
                    ...
                    $("#publicy").append(
                    		                  "<tr>"+
                    		                    deleteCol+ 
                                                 ...
                                                 "  <td>"+cli.type+"</td>" + 
                                                 "  <td>"+valCurexp+"</td>" + 
                                                 " <td>"+"&nbsp"+cli.description+"</td>" + 
                                                 "  <td>"+cli.creatorName+"</td>" + 
                                                 "  <td>"+cli.id+"</td>" + 
                                                 "  <td>"+cli.status+"</td>" +
             ...
             console.log( data);
              ...
              //  $( "#tblListevent" ).addClass( "table table-bordered" );
                ...
                oTable = $('#tblListevent').footable();
                	...
                	{
                // oTable.trigger('footable_redraw');// = $('table').footable();
                	//oTable.data('footable').redraw();
                	oTable.trigger('footable_initialize');
                	//console.log(oTable.data('footable').redraw());
                	}
                    ...
                    oTable.trigger('footable_clear_filter');
                     ...
                     $(".btnEventEdit").bind("click", function(){
                        ...
                        console.log(selected_index);
                            ...
                            var cli = (data.yapps[selected_index]);
                            if(cli == undefined)cli = data.yapps;
                            var popup = window.open("popupevent.html", "_blank", "toolbar=0, scrollbars=0,fullscreen=0, resizable=0, top=100, left=300, width=800, height=450");
                            popup.onload =  function()
                            {
                                console.log(cli.id);
                                var valCurDate = new Date(cli.start);
